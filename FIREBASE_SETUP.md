...
3. Введите:
   - **Package name**: `com.example.qde_realme` (или ваш package name из `android/app/build.gradle.kts`)
...
```dart
import 'package:qde_realme/core/notifications/fcm_token_example.dart';
