...
import '../../slave_data/slave_data_bloc.dart';
import '../../slave_data/slave_data_event.dart';
import '../../slave_data/slave_data_state.dart';

class SlaveHomeContentPage extends StatefulWidget {
  const SlaveHomeContentPage({super.key});

  @override
  State<SlaveHomeContentPage> createState() => _SlaveHomeContentPageState();
}

class _SlaveHomeContentPageState extends State<SlaveHomeContentPage> with AutomaticKeepAliveClientMixin {
  @override
  void initState() {
    super.initState();
